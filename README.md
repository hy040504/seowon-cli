...
이 브랜치(`tui`)는 **터미널 UI만** 있습니다. PyQt 창은 [`gui`](https://github.com/hy040504/seowon-cli/tree/gui), 둘 다는 [`main`](https://github.com/hy040504/seowon-cli/tree/main) 입니다.
...
- `main` — TUI와 GUI를 모두 둠.
- `tui` — 이 브랜치. 터미널만. `lib/front/gui`, `gui_main.c`, `requirements.txt` 없음.
- `gui` — PyQt만. 터미널 메뉴 없음.
